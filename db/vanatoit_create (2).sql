...
ALTER TABLE authorized_user ADD CONSTRAINT authorized_user_shop
    FOREIGN KEY (shop_id)
    REFERENCES shop (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE authorized_user ADD CONSTRAINT authorized_user_user
    FOREIGN KEY (user_id)
    REFERENCES "user" (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE book_food ADD CONSTRAINT book_food_shop_food
...
ALTER TABLE book_food ADD CONSTRAINT book_food_status
...
ALTER TABLE book_food ADD CONSTRAINT book_food_user
    FOREIGN KEY (user_id)
    REFERENCES "user" (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE food ADD CONSTRAINT food_type
    FOREIGN KEY (type_id)
    REFERENCES type (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE shop_food_log ADD CONSTRAINT shop_food_log_food
    FOREIGN KEY (food_id)
    REFERENCES food (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE shop_food_log ADD CONSTRAINT shop_food_log_shop
    FOREIGN KEY (shop_id)
    REFERENCES shop (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE shop_food_log ADD CONSTRAINT shop_food_log_unit
    FOREIGN KEY (unit_id)
    REFERENCES unit (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE shop_food ADD CONSTRAINT shop_goods_food
    FOREIGN KEY (food_id)
    REFERENCES food (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE shop_food ADD CONSTRAINT shop_goods_shop
    FOREIGN KEY (shop_id)
    REFERENCES shop (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE shop_food ADD CONSTRAINT shop_goods_unit
    FOREIGN KEY (unit_id)
    REFERENCES unit (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE shop ADD CONSTRAINT shop_profile
